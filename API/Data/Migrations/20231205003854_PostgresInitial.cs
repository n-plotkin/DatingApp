    ...
    public partial class PostgresInitial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppUserId = table.Column<int>(type: "integer", nullable: false),
                    AppUserUserName = table.Column<string>(type: "text", nullable: true),
                    AccessToken = table.Column<string>(type: "text", nullable: true),
                    TokenType = table.Column<string>(type: "text", nullable: true),
                    Scope = table.Column<string>(type: "text", nullable: true),
                    RefreshToken = table.Column<string>(type: "text", nullable: true),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TopArtist = table.Column<string>(type: "text", nullable: true),
                    TopArtistImageUri = table.Column<string>(type: "text", nullable: true),
                    CurrentSong = table.Column<string>(type: "text", nullable: true),
                    CurrentArtists = table.Column<string>(type: "text", nullable: true),
                    CurrentSongUri = table.Column<string>(type: "text", nullable: true),
                    CurrentArtistsUris = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
