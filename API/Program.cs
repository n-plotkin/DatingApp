...
app.UseCors(builder => builder.AllowAnyHeader()
    .AllowAnyMethod()
    .AllowCredentials()
    .WithOrigins("https://localhost:4200", "https://serendipity.fly.dev"));
...
//This tells our app we want to serve static files as well
//get index.html from wwwroot file
app.UseDefaultFiles();
//looks for wwwroot and serves content in there
app.UseStaticFiles();
